...
jvm.Map = function(params) {
  ...
  if (!jvm.Map.maps[this.params.param]) {
    throw new Error('Attempt to use map which was not loaded: ' + this.params.param);
  }

  this.mapData = jvm.Map.maps[this.params.param];
  this.markers = {};
  this.regions = {};
  this.regionsColors = {};
  this.regionsData = {};
...
jvm.Map.prototype = {
  ...
  getMarkerPosition: function(markerConfig) {
    if (jvm.Map.maps[this.params.param].projection) {
  ...
  latLngToPoint: function(lat, lng) {
    var point,
      proj = jvm.Map.maps[this.params.param].projection,
  ...
  pointToLatLng: function(x, y) {
    var proj = jvm.Map.maps[this.params.param].projection,
      centralMeridian = proj.centralMeridian,
      insets = jvm.Map.maps[this.params.param].insets,
      i,
      inset,
      bbox,
      nx,
  ...
  getInsetForPoint: function(x, y) {
    var insets = jvm.Map.maps[this.params.param].insets,
      i,
      bbox;
